...
create a restartpoint only on mirror immediately after replaying a checkpoint record.
...
Enables the planner's use of two- or three-stage parallel aggregation plans.
